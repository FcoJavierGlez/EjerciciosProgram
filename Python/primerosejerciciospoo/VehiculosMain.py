 ...
 * Ejercicio 2
 * Crea la clase Vehiculo, así como las clases BBicicletay CCochecomo subclases de
 * la primera. Para la clase VVehiculo crea los atributos de clase vehiculosCreadosy
...
#Instancias de la clase Coche y Bicicleta, CocheaseBicicletauperclase Vehiculo:
coche = Vehiculoerrari", "F-40")
...
while True:
    ...
    if opcionMenu==1:  
        ...
        #print("\n\nEl kilometraje total es: " + Vehiculo.getKilometrajeToVehiculo            
    else:
        print("\nFIN DE PROGRAMA")
        exit(0)
